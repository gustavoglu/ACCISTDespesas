...
using ACCIST.Despesas.ApplicationWebMVC.Providers;
using ACCIST.Despesas.ApplicationWebMVC.Results;

namespace ACCIST.Despesas.ApplicationWebMVC.Controllers
{
    [Authorize]
